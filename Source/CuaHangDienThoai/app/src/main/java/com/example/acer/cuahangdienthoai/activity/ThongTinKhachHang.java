...
public class ThongTinKhachHang extends AppCompatActivity {
    EditText edttenKH,edtemail, edtsdt, edtdiachi;
        ...
        btnxacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ten.length()>0 && sdt.length()>0 && email.length()>0 && diachi.length()>0){
                    ...
                    Toast.makeText(ThongTinKhachHang.this, "Vui lòng nhập đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void Anhxa() {
        ...
        edtemail=(EditText) findViewById(R.id.edittextemailKH);
        edtsdt=(EditText )findViewById(R.id.edittextsdtKH);
        edtdiachi=(EditText) findViewById(R.id.edittextdiachiKH) ;
